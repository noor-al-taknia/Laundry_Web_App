export type PublicShop={shop:{name:string;nameAr:string;address:string;phone:string;email:string;maintenanceActive?:boolean}|null;categories:Array<{id:number;name:string;services:Array<{id:number;name:string;nameAr:string;price:number|null}>}>};
